...
def convert(audio_picker,model_picker,index_picker,index_rate,pitch,method):
    ...
    try:
        ...
        return {"choices":show_available("audios"),"__type__":"update","value":f"out_{output_name}.wav"},f"audios/out_{output_name}.wav"
...
with gr.Blocks(theme='Hev832/Pl-tme') as app:
    ...
    with gr.Row():
        ...
        convert_button.click(convert, inputs=inputs,outputs=[audio_picker,audio_player,output_name])
